...
const SideMenu = () => {
  ...
  return (
    <div className="px-4 h-max sticky top-8">
      <h1 className="mb-4 text-sm font-medium">ძებნა</h1>
      <Search />
      <h1 className="mt-8 mb-4 text-sm font-medium">ფილტრი</h1>
      ...
      <h1 className="mt-8 mb-4 text-sm font-medium">კატეგორია</h1>
      <div className="flex flex-col gap-2 text-sm">
