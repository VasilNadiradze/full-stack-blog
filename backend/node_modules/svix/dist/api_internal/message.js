...
const messageEventsSubscription_1 = require("./messageEventsSubscription");
class Message {
    constructor(requestCtx) {
        this.requestCtx = requestCtx;
    }
    get events_subscription() {
        return new messageEventsSubscription_1.MessageEventsSubscription(this.requestCtx);
    }
    ...
    eventsSubscription(appId, subscriptionId, options) {
        const request = new request_1.SvixRequest(request_1.HttpMethod.GET, "/api/v1/app/{app_id}/events/subscription/{subscription_id}");
        request.setPathParam("app_id", appId);
