...
export declare class Authentication {
    ...
    createMessageToken(appId: string, createTokenIn: CreateTokenIn, options?: AuthenticationCreateMessageTokenOptions): Promise<AuthTokenOut>;
    getPollerToken(appId: string, endpointId: string): Promise<AuthTokenOut>;
    rotatePollerToken(appId: string, endpointId: string, rotatePollerTokenIn: RotatePollerTokenIn, options?: AuthenticationRotatePollerTokenOptions): Promise<AuthTokenOut>;
